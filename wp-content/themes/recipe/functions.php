...
if ( ! function_exists( 'recipe_setup' ) ) :
	...
	function recipe_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'recipe_custom_background_args', array(
...
function recipe_scripts() {
	wp_enqueue_style( 'recipe-style', get_stylesheet_uri() );

	wp_enqueue_script( 'recipe-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'recipe-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
